...
namespace ComicBookGallery.Data
{
    ...
    {
        private static ComicBook[] m_ComicBooks = new ComicBook[]
        {
            new ComicBook {
                Id = 1,
        ...
        public ComicBook GetComicBook(int issueNumber)
        {
            return m_ComicBooks.FirstOrDefault(comicBook => comicBook.IssueNumber == issueNumber);
        }

        public ComicBook GetComicBookById(int id)
        {
            return m_ComicBooks.FirstOrDefault(comicBook => comicBook.Id == id);
        }
    }
}